...
import { register, removeErrors, removeSuccess } from '../features/user/userSlice.mjs';
            ...
            <div className="form-content">
                <form className='form' onSubmit={registerSubmit} encType='multipart/form-data' >
                    ...
                    <div className="input-group">
                        <input type="text" placeholder='Username' name='name' value={name} onChange={registeredDataChange} />
                    </div>
                    <div className="input-group">
                        <input type="email" placeholder='Email' name='email' value={email} onChange={registeredDataChange} />
                    </div>
                    <div className="input-group">
                        <input type="password" placeholder='Password' name='password' value={password} onChange={registeredDataChange} />
                    </div>
