...
import { removeErrors, removeSuccess, updateProfile } from '../features/user/userSlice.mjs'
                ...
                <div className="form-content">
                    <form className="form" encType='multipart/form-data' onSubmit={updateSubmit}>
                        ...
                        <div className="input-group avatar-group">
                            <input type="text" accept="image/" className="file-input" name='avatar' onChange={profileImageUpdate} />
