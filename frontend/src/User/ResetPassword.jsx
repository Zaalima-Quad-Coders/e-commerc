...
import { removeErrors, removeSuccess, resetPassword } from '../features/user/userSlice.mjs'
                ...
                <div className="form-content">
                    <form className="form" onSubmit={resetPasswordSubmit}>
                        ...
                        <div className="input-group">
                            <input type="password" name='password' placeholder='Enter your new Password' value={password} onChange={(e) => setOldPassword(e.target.value)} />
                        </div>
                        <div className="input-group">
                            <input type="password" name='newPassword' placeholder='New Password' value={newPassword} onChange={(e) => setPassword(e.target.value)} />
                        </div>
                        <div className="input-group">
